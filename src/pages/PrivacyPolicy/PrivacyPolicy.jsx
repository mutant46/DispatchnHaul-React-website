...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy | Dispatch n Haul";
  }, []);
  return (
    <div
      class="container"
      style={{ color: "", padding: "20px 50px", background: "#f1f1f1" }}
    >
      <h1>Privacy Policy</h1>
      <p>Last updated June 24, 2024</p>
      <p>
        This privacy notice for dispatchnhaul ("we," "us," or "our"), describes
      ...
      <ul>
        <li>
          ...
          <a href="https://dispatchnhaul.com/">https://dispatchnhaul.com/</a>,
      ...
      <ul>
        ...
        <li>
          ...
          <a href="#rights">Learn more about your privacy rights.</a>
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          <a href="#retain">HOW LONG DO WE KEEP YOUR INFORMATION?</a>
        </li>
        <li>
          <a href="#safe">HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
        </li>
        <li>
      ...
      <p>
        <strong>
          If you are located in Europe or the UK, this section applies to you.
        </strong>
      </p>
      <p>
      ...
      <h3 id="transfer">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h3>
      <p>
        <strong>In Short:</strong> We do not transfer, store, and process your
        information in countries other than your own.
      </p>
      <h3 id="safe">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
      <p>
      ...
      <h3 id="rights">9. WHAT ARE YOUR PRIVACY RIGHTS?</h3>
      <p>
      ...
      <h3 id="policy">12. DO WE MAKE UPDATES TO THIS NOTICE?</h3>
      <p>
      ...
      <p>
        ...
        <a href="mailto:dnh@dispatchnhaul.com">dnh@dispatchnhaul.com</a> or by
        post to:
      </p>
      <p>Dispatch n Haul LLC</p>
      <p>United States</p>
      <h3 id="request">
